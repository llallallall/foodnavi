...
export default function DiagnosisApplyPage() {
  return (
    <div className="bg-muted/30 min-h-screen py-8 sm:py-12 px-4 md:px-6">
      <div className="container mx-auto max-w-4xl space-y-6 sm:space-y-8">
        <div className="text-center space-y-3 sm:space-y-4">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight text-primary-dark break-keep">무료 수출 진단 신청</h1>
          <p className="text-muted-foreground text-sm sm:text-base max-w-2xl mx-auto break-keep">
